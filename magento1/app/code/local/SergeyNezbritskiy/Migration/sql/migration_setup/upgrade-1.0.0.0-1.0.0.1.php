...
try {
    $table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('cms/page', array('identifier')),
            array('identifier'))
        ->setComment('This table should be migrated as it is');
...
INSERT INTO migration_table2 (`page_id`, `title`, `root_template`, `meta_keywords`, `meta_description`, `identifier`, `content`, `creation_time`, `update_time`, `is_active`, `sort_order`)
